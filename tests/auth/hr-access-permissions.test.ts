...
describe("Admin / Employee / HR / DM roles", () => {
  ...
  it("uses wholesale cost for Employee, HR, and DMs; real cost for admins", () => {
    ...
    expect(costPriceForRole({ inventoryCost: 900, wholesaleCost: 0 }, "dm", "adeel")).toBe(0);
    expect(costPriceForRole({ inventoryCost: 900, wholesaleCost: 40 }, "dm", "shaun")).toBe(40);
    expect(costPriceForRole({ inventoryCost: 900, wholesaleCost: 40 }, "dm", "rozina")).toBe(40);
    expect(costPriceForRole({ inventoryCost: 900, wholesaleCost: 0 }, "dm", "marina")).toBe(900);
