...
const fieldClass =
  "w-full px-3 py-2.5 rounded-xl border border-white/20 bg-white/10 text-ink text-sm focus:outline-none focus:ring-2 focus:ring-slate-400/30 [color-scheme:dark]";
